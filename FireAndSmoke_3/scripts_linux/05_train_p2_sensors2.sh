...
IMGSZ="${IMGSZ:-960}"
DEVICE="${DEVICE:-0}"
DATA="$ROOT/datasets/strict_sensors_2cls/data.yaml"
MODEL="$PROJECT/models/yolov8m-p2-fire-smoke-2cls.yaml"
PRETRAINED="${PRETRAINED:-$BASE/weights/sensors_yolov8m_2cls_100_best.pt}"
PROJECT_PRETRAINED="$PROJECT/weights/sensors_yolov8m_2cls_100_best.pt"
