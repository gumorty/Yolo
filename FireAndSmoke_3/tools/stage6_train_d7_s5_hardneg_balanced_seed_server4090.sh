...
RUN_NAME="${RUN_NAME:-stage6_d7_s5_hardneg_balanced_x${HARD_REPEAT}_i${IMGSZ}_seed${SEED}}"
GENERATED_DIR="$ROOT/generated"
GENERATED_DATA="$GENERATED_DIR/stage6_d7_s5_hardneg_balanced_x${HARD_REPEAT}_seed${SEED}_server.yaml"
...
echo "DEVICE=$DEVICE BATCH=$BATCH IMGSZ=$IMGSZ EPOCHS=$EPOCHS HARD_REPEAT=$HARD_REPEAT SEED=$SEED"
...
echo "D7 S5-balanced seed reproducibility run complete."
